...
export async function GET(request: NextRequest) {
  const checkInId = Sentry.captureCheckIn(
    { monitorSlug: "audit-trail-daily-sync", status: "in_progress" },
    {
  ...
  try {
    ...
    if (!cronSecret) {
      ...
      Sentry.captureCheckIn({ monitorSlug: "audit-trail-daily-sync", checkInId, status: "error" });
    ...
    Sentry.captureCheckIn({ monitorSlug: "audit-trail-daily-sync", checkInId, status: "ok" });
