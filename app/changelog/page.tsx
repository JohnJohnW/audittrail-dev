...
const changelog: ChangelogEntry[] = [
  {
    ...
    description:
      "Added four new compliance frameworks: NIST CSF 2.0, NIST SP 800-53 Rev 5, SOC 2, and PCI DSS 4.0. Audit Trail now maps GitHub activity to 39 controls across 6 frameworks. Rebranded to Audit Trail.",
  },
  {
    date: "2026-01-20",
    version: "1.0.0",
